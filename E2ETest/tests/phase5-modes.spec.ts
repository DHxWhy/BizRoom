/**
 * Phase 5: Mode Switching — Live → DM → Auto
 *
 * Validates:
 * - Default Live mode: multiple agents can respond
 * - DM mode: only the selected agent (Amelia / CFO) responds; others silent
 * - Live restore: switching back allows multi-agent responses again
 * - Auto mode: banner / indicator appears for autonomous discussion
 * - Mode switch latency: UI transition < 1s
 */
