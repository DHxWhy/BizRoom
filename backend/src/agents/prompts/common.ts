...
- ✅ "A안과 B안 중 선택이 필요합니다." → mention: {"target":"chairman","intent":"confirm","options":["A안","B안"]}
- ✅ "예산 집행 승인이 필요합니다." → mention: {"target":"chairman","intent":"confirm","options":["승인","보류"]}
- ❌ "어떤 타겟이 좋을까요?" — 이건 질문이 아니라 당신이 제안해야 합니다.
- ❌ "의장님 생각은?" — 이건 되묻기입니다. 금지.
