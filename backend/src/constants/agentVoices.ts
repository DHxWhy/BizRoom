...
export const AGENT_VOICES: Record<AgentRole, AgentVoiceConfig> = {
  ...
  // verse: dynamic male — fits passionate CMO
  cmo: { role: "cmo", voiceName: "en-US-Andrew:DragonHDLatestNeural", openaiVoice: "verse", locale: "en-US", temperature: 0.9 },
  ...
  // ballad: warm engaging male — fits creative CDO (Jonas is male)
  cdo: { role: "cdo", voiceName: "en-US-Brian:DragonHDLatestNeural", openaiVoice: "ballad", locale: "en-US", temperature: 0.9 },
