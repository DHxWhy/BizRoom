...
export const AGENT_VOICES: Record<AgentRole, AgentVoiceConfig> = {
  ...
  // ballad: warm engaging male — fits passionate CMO (Yusef)
  ...
  // verse: versatile male — fits creative CDO (Jonas)
  cdo: { role: "cdo", voiceName: "en-US-Brian:DragonHDLatestNeural", openaiVoice: "verse", locale: "en-US", temperature: 0.9 },
